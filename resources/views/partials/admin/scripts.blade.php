...
<!-- Blockchain libs -->
<script src="{{ asset('js/libs/bignumber.js') }}"></script>
<script src="{{ asset('js/libs/web3.js') }}"></script>
<script src="{{ asset('js/libs/truffle-contract.js') }}"></script>
<!--  -->

<!-- Custom script to manipulate the blockchain -->
<script src="{{ asset('js/contract-handler.js') }}"></script>
<!--  -->
