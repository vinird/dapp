    ...
    <div class="panel panel-default">
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center">
              <h3 class="h4">Agregar correos al evento / (Nombre del evento) </h3>
            </div>
            <br>
            <div class="card-body">
                <form method="POST" action="{{ url('/test') }}" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                  <!--  -->
                  ...
                  <div id="div_file">
                    ...
                    <div class="form-group" >
                      <!-- <label class="form-control-label">Correos</label> -->
                      <input type="file" id="btn_select_file" class="form-control">
